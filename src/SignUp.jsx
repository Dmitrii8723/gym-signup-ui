...
const {
        formState: { errors }, register, handleSubmit, getValues,
...
return(<div>
{formSubmitted &&(<span css={css`${positionStyple} top: 30%;`}>
    {`Before login to Gym platform, you’ll need to verify your account. 
    We’ve sent a verification link to ${email}`}
</span>
)}
{!formSubmitted && (<form css={css`
${positionStyple}
    top: 50%;
...
<span css={css(errorMessage)}>{errors.userAlreadyExist.message}</span>
)}
<button
css={css`
  padding: 1em; 
